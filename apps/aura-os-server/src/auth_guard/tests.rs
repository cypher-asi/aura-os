...
fn mock_app_state_with_cache(cache: crate::state::ValidationCache) -> AppState {
    ...
    AppState {
        ...
        web_search_rate_limiter: crate::tool_action_rate_limit::WebSearchRateLimiter::default(),
        ...
        push_notifications: Arc::new(
            crate::push_notifications::PushNotificationService::disabled(store.clone()),
        ),
