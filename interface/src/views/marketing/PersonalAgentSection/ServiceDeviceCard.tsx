 ...
 * the reference sampler/composer device. An inset, glossy black screen
 * holds the services AURA connects to as glowing, emissive on-screen
 * widgets (the monochrome `SERVICE_LOGOS` marks, painted in
 * `currentColor` with a soft glow rather than the old bordered tiles).
 *
...
export function ServiceDeviceCard(): ReactNode {
  return (
    <div className="personalAgentDevice" aria-hidden="true">
