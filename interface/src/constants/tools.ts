export const TOOL_LABELS: Record<string, string> = {
  ...
  update_spec_section: "Update spec section",
  append_to_spec: "Append to spec",
  ...
  list_org_integrations: "List integrations",
  gmail_search_messages: "Search Gmail",
  gmail_get_message: "Read Gmail message",
  gmail_send_email: "Send Gmail",
  gmail_create_draft: "Create Gmail draft",
  gmail_send_draft: "Send Gmail draft",
...
export const TOOL_PHASE_LABELS: Record<string, string> = {
  ...
  update_spec_section: "Editing spec section...",
  append_to_spec: "Appending to spec...",
  ...
  list_org_integrations: "Checking connected integrations...",
  gmail_search_messages: "Searching Gmail...",
  gmail_get_message: "Reading Gmail...",
  gmail_send_email: "Sending Gmail...",
  gmail_create_draft: "Creating Gmail draft...",
  gmail_send_draft: "Sending Gmail draft...",
  google_calendar_list_calendars: "Checking calendars...",
  google_calendar_list_events: "Reading calendar...",
