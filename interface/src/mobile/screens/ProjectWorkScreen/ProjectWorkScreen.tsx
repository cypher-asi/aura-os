...
export function MobileProjectWorkScreen() {
  const ctx = useProjectActions();
  const { projectId: routeProjectId } = useParams<{ projectId: string }>();
  const projectId = ctx?.project.project_id ?? routeProjectId;
